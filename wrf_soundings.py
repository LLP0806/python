#!/usr/bin/env python
# -*- coding:utf-8 -*-
# @Time : 2023/3/29 12:01
# @Author : LIPING LUO
# @File : wrf_soundings.py
...
station_total = ['sounds_wrf_d02_148_385_043000UTC_Xuzhou','sounds_wrf_d02_148_385_043006UTC_Xuzhou','sounds_wrf_d02_148_385_043012UTC_Xuzhou',\
                   'sounds_wrf_d02_252_209_043000UTC_Nanjing','sounds_wrf_d02_252_209_043006UTC_Nanjing','sounds_wrf_d02_252_209_043012UTC_Nanjing',\
                   'sounds_wrf_d02_340_343_043000UTC_Yancheng','sounds_wrf_d02_340_343_043006UTC_Yancheng','sounds_wrf_d02_340_343_043012UTC_Yancheng',\
                   'sounds_wrf_d02_412_169_043000UTC_Shanghai','sounds_wrf_d02_412_169_043006UTC_Shanghai','sounds_wrf_d02_412_169_043012UTC_Shanghai',\
                 'sounds_wrf_d02_536_365_043006UTC_Oversea']
for i in range(len(station_total)):
    ...
    data = pd.read_csv('/Users/lpluo/Desktop/20210430_Cold_Vortex/observations/'+station_obstime+'.txt',sep='\s+',header=0,\
                       usecols=['Pres', 'Height', 'Tc', 'Tdc', 'Vtspeed', 'Vtdir'])
    ...
    height = data_no_duplicate['Height'].values # * units.gpm   # units:gph
    p = data_no_duplicate['Pres'].values # * units.hPa    # units:hPa
    T = data_no_duplicate['Tc'].values  # * units.degC       # units:degC
    Td = data_no_duplicate['Tdc'].values # * units.percent                 # units: %
    wind_speed = data_no_duplicate['Vtspeed'].values # * units("m/s")
    wind_dir = data_no_duplicate['Vtdir'].values # * units.degrees
    ...
    for i in range(len(data_new_sorted)):
        if data_new_sorted[i][1] >= 90:  # 只选取气压大于100hPa的值；
    ...
    plt.title(station_obstime[7:15] + station_obstime[23:len(station_obstime)] + '  ' + 'CAPE = ' + str(round(cape.m,2)) + ' J/Kilogram' + '  ' + 'CIN = ' + ' ' + str(round(cin.m,2)) + ' J/Kilogram', \
    ...
    plt.savefig('/Users/lpluo/Desktop/20210430_Cold_Vortex/observations/' + station_obstime[7:15] + station_obstime[23:len(station_obstime)] + '.pdf')
    # plt.show()
    del l
